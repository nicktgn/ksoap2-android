...
public class KeepAliveHttpsTransportSE extends HttpsTransportSE
{
    ...
    /**
     * Get a service connection. Returns an implementation of {@link org.ksoap2x.transport.ServiceConnectionSE} that
     * ignores "Connection: close" request property setting and has "Connection: keep-alive" always set and is uses
     * a https connection.
     * @see org.ksoap2x.transport.HttpTransportSE#getServiceConnection()
     */
    //@Override
